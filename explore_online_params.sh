...
model_path=${base_model_path}/${task}_${src_lan}${trg_lan}_GroundHogModel_src_emb_420_bidir_True_enc_LSTM_500_dec_LSTM_500_deepout_linear_trg_emb_420_Adadelta_1.0
model_files=update_160000
...
for algo in PAS PPAS ; do
    for lr in 0.5 0.1 0.05 0.01 0.005 0.001 0.0001 0.00001 0.000001 ; do
        for c in 0.5 0.1 0.05 0.01 0.005 0.001 0.0001 0.00001 0.000001 ; do
            ...
            python main.py --config ${model_path}/config.pkl --dataset datasets/Dataset_${task}_${src_lan}${trg_lan}.pkl \
                   ...
                   -hyp ${dest_dir}/hyps.${task}_${src_lan}${trg_lan}.${algo}.${lr}.${c} \
