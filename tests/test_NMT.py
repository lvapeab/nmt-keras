...
def test_NMT_Bidir_GRU_GRU():
    params = load_tests_params()

    # Current test params: Single layered BGRU - GRU
...
def test_NMT_Unidir_deep_GRU_GRU():
    params = load_tests_params()
...
def test_NMT_Unidir_deep_LSTM_GRU():
    params = load_tests_params()
...
def test_NMT_Bidir_deep_GRU_ConditionalGRU():
    params = load_tests_params()
...
def test_NMT_Unidir_deep_GRU_ConditionalGRU():
    params = load_tests_params()

    # Current test params: Two-layered GRU - ConditionalGRU
    params['BIDIRECTIONAL_ENCODER'] = False
    params['N_LAYERS_ENCODER'] = 2
    params['BIDIRECTIONAL_DEEP_ENCODER'] = False
    params['ENCODER_RNN_TYPE'] = 'GRU'
...
def test_NMT_Unidir_deep_LSTM_ConditionalGRU():
    params = load_tests_params()
...
def test_NMT_Bidir_deep_GRU_LSTM():
    params = load_tests_params()

    # Current test params: Two-layered GRU - LSTM
    params['BIDIRECTIONAL_ENCODER'] = True
    params['N_LAYERS_ENCODER'] = 2
    params['BIDIRECTIONAL_DEEP_ENCODER'] = False
    params['ENCODER_RNN_TYPE'] = 'GRU'
...
def test_NMT_Bidir_deep_LSTM_LSTM():
    params = load_tests_params()
...
def test_NMT_Bidir_LSTM_ConditionalLSTM():
    params = load_tests_params()
...
def test_NMT_Unidir_LSTM_ConditionalLSTM():
    params = load_tests_params()
...
def test_NMT_Bidir_deep_GRU_ConditionalLSTM():
    params = load_tests_params()
