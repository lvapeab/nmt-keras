...
class TestLoadParams(unittest.TestCase):
    ...
    def test_params_exist(self):
        ...
        self.assertIn('ENCODER_RNN_TYPE', params.keys())
        self.assertIn('DECODER_RNN_TYPE', params.keys())
    ...
    def test_params_type(self):
        ...
        self.assertIsInstance(params['ENCODER_RNN_TYPE'], str)
        self.assertIsInstance(params['DECODER_RNN_TYPE'], str)
